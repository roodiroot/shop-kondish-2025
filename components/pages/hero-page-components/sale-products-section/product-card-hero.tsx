...
const ProductCardHero: React.FC<ProductCardHeroProps> = ({
  ...
  return (
    <div className="relative h-full flex flex-col overflow-hidden rounded-lg border bg-white">
      <div className="relative w-full aspect-[2/1.8] p-1">
      ...
      <div className="p-3 flex-1 flex h-full flex-col space-y-2 justify-between">
        <div className="">
