...
interface SaleProductsSectionProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  products?: Product[];
}
...
const SaleProductsSection: React.FC<SaleProductsSectionProps> = ({
  ...
  return (
    <BaseContainer className={cn("sm:mt-10", className)}>
...
const Catalog = () => {
  return (
    <div className="flex gap-2 items-center text-primary mt-6">
      <Link className="text-sm font-bold" href={"/catalog/kondczionery/split-sistemy"}>
        В каталог
      </Link>
